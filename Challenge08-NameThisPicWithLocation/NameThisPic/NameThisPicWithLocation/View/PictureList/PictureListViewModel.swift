...
extension PictureListView {
    ...
    class ViewModel: ObservableObject {
        ...
        @Published var tappedImageLocation: Location = Location(latitude: 0.0, longitude: 0.0)
        ...
        func saveSelectedImage(name: String, location: Location) {
            let saveName = UUID().uuidString
            let picture = NamedPicture(name:saveName, displayName: name, location: location)
